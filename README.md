...
You can use `/play` with links to Spotify tracks, albums and playlist, e.g
...
> [!IMPORTANT]
>
> The Bot doesn't play from Spotify directly, it finds a mirror for each. In the vast majority of cases this is > not an
